...
@test "docs-ssh-key with space" {
    ...
    stub rsync_schema.sh "$(capture_program_args "rsync_schema")"
    stub cleanup_ssh.sh "$(capture_program_args "cleanup_ssh")"

    run action.sh --docs-username USER --docs-host HOST --docs-ssh-key 'SSH KEY' --docs-ssh-host-key HOST_KEY --site-path SITE_PATH --github-repository spring-projects/spring-security --version VERSION
    ...
    assert_program_args "rsync_schema" "--ssh-host USER@HOST --ssh-host-path /var/www/domains/spring.io/docs/htdocs/autorepo/schema/spring-security/VERSION/ --local-path SITE_PATH --ssh-private-key-path $HOME/.ssh/spring-projects/spring-security"
    ...
    unstub rsync_schema.sh
    unstub cleanup_ssh.sh
}

@test "missing docs-ssh-host-key" {
     run action.sh --docs-username USER --docs-host HOST --docs-ssh-key KEY --site-path SITE_PATH --github-repository spring-projects/spring-security --version VERSION
     assert [ "$status" -eq 1 ]
...
@test "docs-ssh-host-key with space" {
    ...
    run action.sh --docs-username USER --docs-host HOST --docs-ssh-key 'SSH_KEY' --docs-ssh-host-key 'HOST KEY' --site-path SITE_PATH --github-repository spring-projects/spring-security --version VERSION
...
@test "missing version" {
  ...
  assert [ "$status" -eq 1 ]
  assert [ "${lines[0]}" = "Error: Missing option '--version'" ]
  assert [ "${lines[1]}" = 'usage: action.sh [OPTION]...' ]
}

@test "missing github-repository" {
     run action.sh --docs-username USER --docs-host HOST --docs-ssh-key KEY --docs-ssh-host-key HOST_KEY --site-path SITE_PATH --version VERSION
     assert [ "$status" -eq 1 ]
...
@test "valid arguments" {
    ...
    run action.sh --docs-username USER --docs-host HOST --docs-ssh-key KEY --docs-ssh-host-key HOST_KEY --site-path SITE_PATH --github-repository spring-projects/spring-security --version VERSION
...
@test "missing site-path defaults build/site" {
    ...
    run action.sh --docs-username USER --docs-host HOST --docs-ssh-key KEY --docs-ssh-host-key HOST_KEY --github-repository spring-projects/spring-security --version VERSION

    assert_success
    assert_program_args "setup_ssh" "--ssh-private-key-path $HOME/.ssh/spring-projects/spring-security --ssh-private-key KEY --ssh-known-host HOST_KEY"
    assert_program_args "rsync_schema" "--ssh-host USER@HOST --ssh-host-path /var/www/domains/spring.io/docs/htdocs/autorepo/schema/spring-security/VERSION/ --local-path build/schema --ssh-private-key-path $HOME/.ssh/spring-projects/spring-security"
    assert_program_args "cleanup_ssh" "--ssh-private-key-path $HOME/.ssh/spring-projects/spring-security"
...
@test "site-path where path exists does not default build/site" {
    ...
    run action.sh --docs-username USER --docs-host HOST --site-path "$BATS_TEMP_DIR" --docs-ssh-key KEY --docs-ssh-host-key HOST_KEY --github-repository spring-projects/spring-security --version VERSION

    assert_success
    assert_program_args "setup_ssh" "--ssh-private-key-path $HOME/.ssh/spring-projects/spring-security --ssh-private-key KEY --ssh-known-host HOST_KEY"
    assert_program_args "rsync_schema" "--ssh-host USER@HOST --ssh-host-path /var/www/domains/spring.io/docs/htdocs/autorepo/schema/spring-security/VERSION/ --local-path $BATS_TEMP_DIR --ssh-private-key-path $HOME/.ssh/spring-projects/spring-security"
    assert_program_args "cleanup_ssh" "--ssh-private-key-path $HOME/.ssh/spring-projects/spring-security"
...
@test "dry-run=true" {
    ...
    run action.sh --docs-username USER --docs-host HOST --docs-ssh-key KEY --docs-ssh-host-key HOST_KEY --site-path SITE_PATH --github-repository spring-projects/spring-security --version VERSION --dry-run

    assert_success
    assert_program_args "setup_ssh" "--ssh-private-key-path $HOME/.ssh/spring-projects/spring-security --ssh-private-key KEY --ssh-known-host HOST_KEY"
    assert_program_args "rsync_schema" "--ssh-host USER@HOST --ssh-host-path /var/www/domains/spring.io/docs/htdocs/autorepo/schema/spring-security/VERSION/ --local-path SITE_PATH --ssh-private-key-path $HOME/.ssh/spring-projects/spring-security --dry-run"
    assert_program_args "cleanup_ssh" "--ssh-private-key-path $HOME/.ssh/spring-projects/spring-security"
